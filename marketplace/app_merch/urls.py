...
urlpatterns = [
    ...
    path(
        "products/all_product_discounts/",
        AllDiscountView.as_view(),
        name="all-discounts",
    ),
    path(
        "product_detail/<int:pk>/", ProductDetailView.as_view(), name="product-detail"
    ),
    path(
        "product_detail/<int:pk>/purchase/",
