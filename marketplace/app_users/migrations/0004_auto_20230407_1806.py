...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_status', models.CharField(choices=[('not_paid', 'Не оплачен'), ('paid', 'Оплачен')], max_length=20, verbose_name='статус оплаты')),
                ...
                ('order_status', models.CharField(choices=[('is_delivering', 'Доставляется'), ('delivered', 'Доставлен')], max_length=20, verbose_name='статус доставки')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.AlterField(
            model_name='profile',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='profile', to=settings.AUTH_USER_MODEL, verbose_name='пользователь'),
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
        ...
        migrations.AddField(
            model_name='order',
            name='buyer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='app_users.buyer', verbose_name='покупатель'),
        ),
        migrations.AddField(
            model_name='order',
            name='delivery_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='app_users.deliverytype', verbose_name='тип доставки'),
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='app_users.payment', verbose_name='тип оплаты'),
        ),
    ]
